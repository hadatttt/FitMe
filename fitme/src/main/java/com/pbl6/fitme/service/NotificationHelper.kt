package com.app.animation_maker.service
...
object NotificationHelper {
    ...
    fun testNotification(context: Context) {
        ...
        val notification = NotificationCompat.Builder(context, "test_channel")
            .setSmallIcon(R.drawable.ic_logo_app).setContentTitle("Test Notification")
    ...
    fun checkPermission(
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            ...
            if (notificationManager.areNotificationsEnabled()) {
                ...
                onGranted()
            } else if (fragment.shouldShowRequestPermissionRationale(Manifest.permission.POST_NOTIFICATIONS)) { } else {
